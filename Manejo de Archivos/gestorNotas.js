...
const filePath = './notas.json';
    ...
    function agregarNota(titulo, contenido) {
        ...
        if (fs.existsSync(filePath)) {
            ...
            // Asignar el valor de data a notas convertido en objeto
    ...
    function listarNotas() {
        if (fs.existsSync(filePath)) {
            // Debe leer y parsear el contenido del archivo.
            // COMPLETAR: Usa fs.readFileSync para leer y JSON.parse para convertir el contenido.
            //Leer archivo texto
            const data = fs.readFileSync(filePath, 'utf8');
            // Convertir texto en arreglo de objetos
            const notas = JSON.parse(data)

            console.log('--- Notas ---');
            // Recorrer el arreglo para mostar titulos
